(function($) {
  ...
  if ($.fn.meanmenu) {
    $('nav#dropdown').meanmenu({
      siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='index.html'><img src='media/logo-mobile.svg' alt='logo' class='img-fluid'/></a></div>"
    });
  }
  ...
  -------------------------------------*/
$(function () {
	$('#clock-b').countdown('2021/2/22').on('update.countdown', function(event) {
    var $this = $(this).html(event.strftime(''
      + '<div class="holder m-1"><span class="h1 font-weight-bold">%D</span> Day%!d</div>'
      + '<div class="holder m-1"><span class="h1 font-weight-bold">%H</span> Hr</div>'
      + '<div class="holder m-1"><span class="h1 font-weight-bold">%M</span> Min</div>'
      + '<div class="holder m-1"><span class="h1 font-weight-bold">%S</span> Sec</div>'));
  });
	});